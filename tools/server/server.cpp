...
int main(int argc, char ** argv) {
    ...
    ctx_http.get ("/api/expert-freq",          ex_wrapper(routes.get_expert_freq)); // public endpoint (no API key check)
    ctx_http.post("/api/expert-freq/reset",    ex_wrapper(routes.post_expert_freq_reset));
